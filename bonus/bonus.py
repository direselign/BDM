...
def pickRandomCoeffs(k):
    # Create a list of 'kpickRandomCoeffs' random values.
    randList = []
...
docid = int(input("Please enter the document id you are interested in. The valid document ids are 1 - " + str(numDocs) + ": "))
